...
(function($) {
  ...
  defaults = {
    ...
    inputs: {
      ...
      perPageText: 'Contacts par page : ',
      pageText: 'Pages : ',
      recordCountPageBoundTemplate: '{pageLowerBound} to {pageUpperBound} of',
      recordCountPageUnboundedTemplate: '{recordsShown} contacts affichés sur',
      recordCountTotalTemplate: '{recordsQueryCount} {collectionName}',
      recordCountFilteredTemplate: ' (résultat filtré sur {recordsTotal} au total)',
      recordCountText: '',
